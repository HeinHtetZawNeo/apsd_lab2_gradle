...
public class EmployeeUtil {
    public static List<Employee> sortForTaskA(List<Employee> employees) {
        return employees
                .stream()
    ...
    public static List<Employee> filterForTaskB(List<Employee> employees) {
        return employees
                .stream()
